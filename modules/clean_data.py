...
def clean():
    ...
    demo = pd.read_sas(f"{RAW}/DEMO_J.XPT", format="xport")
    ghb  = pd.read_sas(f"{RAW}/GHB_J.XPT", format="xport")
    glu  = pd.read_sas(f"{RAW}/GLU_J.XPT", format="xport")
    hiq  = pd.read_sas(f"{RAW}/HIQ_J.XPT", format="xport")
    smq  = pd.read_sas(f"{RAW}/SMQ_J.XPT", format="xport")
    alq  = pd.read_sas(f"{RAW}/ALQ_J.XPT", format="xport")
    paq  = pd.read_sas(f"{RAW}/PAQ_J.XPT", format="xport")
    diq  = pd.read_sas(f"{RAW}/DIQ_J.XPT", format="xport")
